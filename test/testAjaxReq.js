...
ajaxReq.globalFuncs = null; // = require('../scripts/globalFuncs');
ajaxReq.parentObj = null; // = require('./testParentObj');
ajaxReq.BigNumber = null; // = require('bignumber.js');
ajaxReq.request = null; // = require('request');
